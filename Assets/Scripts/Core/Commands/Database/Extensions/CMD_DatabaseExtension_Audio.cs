...
namespace COMMANDS
{
    public class CMD_DatabaseExtension_Audio : CMD_DataBaseExtension
    {
        ...
        private static string[] PARAM_START_VOLUME = new string[] { "-c", "-channel" };
        ...
        new public static void Extend(CommandDataBase database)
        {
            ...
            database.AddCommand("stopambience", new Action<string>(StopSFX));
        }
        private static void PlaySFX(string[] data)
        {
            ...
            if(sound==null)
            {
                Debug.Log($"Unable to load Soundeffect '{filepath}'.");
                return;
            }
        ...
        private static void PlayVoice(string[] data)
        {
            ...
            if (sound == null)
            {
                Debug.Log($"Unable to load voice '{filepath}'.");
                return;
            }
