...
public class GraphicLayer
{
    ...
    public Coroutine SetVideo(VideoClip tex, float transitionSpeed = 1f,bool useAudio = true, Texture blendingTexture = null, string filePath = "", bool immediate = false)
    {
        return CreateGraphic(tex, transitionSpeed, filePath, useAudio, blendingTexture,immediate);
    }
