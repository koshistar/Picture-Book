...
public class AudioManager : MonoBehaviour
{
    ...
    public const float TRACK_TRANSITIONN_SPEED = 1f;
    ...
    public AudioTrack PlayTrack(string filePath, int channel = 0, bool loop = false, float startingVolume = 0f, float volumeCap = 1f, float pitch = 1f)
    {
        ...
        if(clip==null)
        {
            Debug.LogError($"Could not load audio file '{filePath}'. Please make sure this exists in the Resources dictionary.");
            return null;
        }
