...
namespace CHARACTERS
{
    public abstract class Character
    {
        ...
        public const bool DEFAULT_ORIENTATION_IS_FASING_LEFT = true;
        public const string ANIMATION_REFRESH_TRIGER = "Refresh";
        public string name = "";
        ...
        protected bool facingLeft = DEFAULT_ORIENTATION_IS_FASING_LEFT;
        ...
        public Character(string name,CharacterConfigData config,GameObject prefab)
        {
            ...
            if(prefab!=null)
            {
                Transform parentPanel = (config.characterType == CharacterType.Live2D ? characterManager.characterPanel_Live2D : characterManager.characterPanel);
                ...
                //        parentPanel = characterManager.characterPanel_Live2D;
                //        break;
                //    case CharacterType.Model3D:
                //        parentPanel = characterManager.characterPanel_Model3D;
                //        break;
                //}
        ...
        public Coroutine Say(List<string> dialogue)
        {
            ...
            UpdataTextCustomizationOnScreen();
        ...
        public void UpdataTextCustomizationOnScreen() => dialogueSystem.ApplySpeakerDataToDialogueContainer(config);
        ...
        public void Animate(string animation,bool state)
        {
            ...
            animator.SetTrigger(ANIMATION_REFRESH_TRIGER);
        }
